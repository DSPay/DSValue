...
extern const int64_t BTC_START_HIGHT;
extern const uint256 hashBitcoinStartBlock;
extern const uint256 hashBitcoinStartPreBlock;
extern const uint256 hashBitcoinStartMerkleRoot;
