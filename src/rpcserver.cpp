...
{ //  name                      actor (function)         okSafeMode threadSafe reqWallet
  //  ------------------------  -----------------------  ---------- ---------- ---------
    ...
    { "sendlottobet",           &sendlottobet,           false,     false,      true },
    { "getacountbyaddress",     &getacountbyaddress,      false,     false,      true },
    ...
    { "sendcheckpoint",         &sendcheckpoint,         false,     false,      true  },
    { "sendlottokey",           &sendlottokey,           false,     false,      true },
    { "gettotalcoinsvalues",    &gettotalcoinsvalues,    false,     false,      true },
    { "saveblocktofile",        &saveblocktofile,        false,     false,      true },
    { "getluckynum",        	&getluckynum,            false,     false,      true },
    { "listluckynum",        	&listluckynum,           false,     false,      true },
    { "gettransactionbyaddr", 	&gettransactionbyaddr,   false,     false,      true },
    { "listlottokey",           &listlottokey,           false,     false ,      true},
    { "gettransactionbyheight", &gettransactionbyheight, false,     false ,      true},
