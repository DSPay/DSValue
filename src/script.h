...
public:
    ...
    {
        return (size() > 0 && (*begin() == OP_RETURN || *begin() == OP_LOTTOUNSPEND));
    }
    ...
    bool GetBetData(std::vector<unsigned char>& nBetData) const;
    uint160 GetLottoPoolAddressFromTx() const;
	bool IsSendPoolAdress() const;
};
